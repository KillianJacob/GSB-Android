...
public class CreateBdEchantillon extends SQLiteOpenHelper {
  ...
  private static final String TABLE_ECHANTILLONS = "table_echantillons";
  ...
  public CreateBdEchantillon(Context context, String name, CursorFactory factory,	int version) {
  ...
  public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
    ...
    db.execSQL("DROP TABLE " + TABLE_ECHANTILLONS + ";");
    onCreate(db);
  }
